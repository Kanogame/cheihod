...
func StartHttpServer(port int) {
	var c = cors.New(cors.Options{
		AllowedOrigins: []string{"http://127.0.0.1:5501", "http://127.0.0.1:10235", "http://192.168.1.7:5501", "http://176.65.35.172:80", "http://176.65.35.172:11220", "http://176.65.35.172:80/api", "http://176.65.35.172:80/admin", "http://176.65.35.172/admin", "http://176.65.35.172", "http://176.65.35.172/api"},
	})
